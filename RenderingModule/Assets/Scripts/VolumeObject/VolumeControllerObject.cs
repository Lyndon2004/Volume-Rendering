...
namespace UnityVolumeRendering
{
    ...
    public class VolumeControllerObject : MonoBehaviour
    {
        ...
        private void UpdateMatInternal(int index)
        {
            ...
            //  Cliped Height��Ҫ�ֿ����
            //  ���index < floor(cliped_height * meshRenderers.Length), index_height = 1
            //  ���index > floor(cliped_height * meshRenderers.Length), index_height = 0
            //  ���index = floor(cliped_height * meshRenderers.Length), index_height = 1 - frac(cliped_height * meshRenderers.Length)
            float index_heightX;
            float index_heightY;
            ...
            //  ���index_heightX = 1 ���� index_heightY = 0, ����Ⱦ
